package com.javangarda.fantacalcio.web.contexts.social;
...
private UserIdSource userIdSource;
	...
	public void configure(HttpSecurity http) throws Exception {		
		...
		http.authenticationProvider(
				new CustomSocialAuthenticationProvider(usersConnectionRepository, socialUsersDetailsService))
	 ...
	 * @return this SpringSocialConfigurer for chained configuration
	 */
	public CustomSpringSocialConfigurer defaultFailureUrl(String defaultFailureUrl) {
