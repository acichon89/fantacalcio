...
public class UserRepositoryIntegrationTest {
    ...
    public void init(){
        user = new User("123");
        user.register("John Doe", "pass");
        user.assignEmailToBeConfirmed("johndoe@example.com", "token");
    }
    ...
    public void findByEmailTest(){
        ...
        //when:
        Optional<User> userOpt = userRepository.findByEmail("johndoe@example.com");
        Optional<User> userOpt2 = userRepository.findByEmail("notexistingmail@example.com");
        //then:
    ...
    public void findByResetPasswordTokenTest(){
        ...
        Optional<User> userOpt2 = userRepository.findByResetPasswordToken("token2222222");
        //then:
        assertTrue(userOpt.isPresent());
        userOpt.ifPresent(u -> assertEquals("123", u.getId()));
        assertFalse(userOpt2.isPresent());
...
@Configuration
@EntityScan("com.javangarda.fantacalcio.user.application.model")
class Context {
    @Bean
